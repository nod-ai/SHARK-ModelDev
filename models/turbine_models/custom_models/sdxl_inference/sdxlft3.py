...
def train_func(pixel_values, samples, input_ids_1, input_ids_2, uncond_ids_1, uncond_ids_2):
    ...
    #)
    noise_pred = run_torch_diffusers_loop(sample, prompt_embeds, text_embeds, args)
    ...
    for epoch in range(num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            if args.use_torchdynamo:
                ...
                print("DEBUG T00")
                train_func(batch["pixel_values"], samples[0], batch["input_ids_1"], batch["input_ids_2"], batch["uncond_ids_1"], batch["uncond_ids_2"])
                print("DEBUG T01")
