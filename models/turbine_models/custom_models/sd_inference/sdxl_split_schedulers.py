...
parser.add_argument(
    "--iree_target_triple",
    type=str,
    default="x86_64-unknown-unknown-eabi-elf",
...
# scheduler_module = SDXLScheduler(hf_model_name, 3, scheduler, hf_auth_token=None, precision="fp32")
# sample = torch.randn(1, 4, 128, 128)
...
# print(scheduler_module.forward(sample, prompt_embeds, text_embeds, time_ids))
...
if __name__ == "__main__":
    ...
    # prompt_embeds = torch.randn((2, 77, 2048))
    # text_embeds = torch.randn((2, 1280))
    # time_ids = torch.randn((2, 6), dtype=torch.int32)
    # print(scheduler_module.forward(sample, prompt_embeds, text_embeds, time_ids))
