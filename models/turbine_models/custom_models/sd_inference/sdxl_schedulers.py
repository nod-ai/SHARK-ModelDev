...
def export_scheduler(
    ...
    class CompiledScheduler(CompiledModule):
        ...
        def main(
            ...
            guidance_scale = AbstractTensor(*guidance_scale, dtype=torch.float32),
        ):
            # print(f"guidance_scale : {guidance_scale.__repr__()} | time_ids : {time_ids.__repr__()}")
            # import pdb; pdb.set_trace()
            return jittable(scheduler.forward)(sample, prompt_embeds, text_embeds, time_ids)
