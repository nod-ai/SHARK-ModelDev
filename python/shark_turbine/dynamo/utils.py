...
def is_minimum_torch_version(current_torch_version):
    is_minimum = False
    try:
        parse_current_version = pkg_resources.parse_version(current_torch_version)
        parse_minimum_version = pkg_resources.parse_version("2.1.0")
        is_minimum = parse_current_version == parse_minimum_version
...
if is_minimum_torch_version(current_torch_version):
